...
rotated_ST_rhizo$Reaction <- rep("Other", nrow(rotated_ST_rhizo))
rotated_ST_agro$Reaction <- rep("Other", nrow(rotated_ST_agro))
rotated_ST_para$Reaction <- rep("Other", nrow(rotated_ST_para))
rotated_ST_bacillus$Reaction <- rep("Other", nrow(rotated_ST_bacillus))
rotated_ST_burkho$Reaction <- rep("Other", nrow(rotated_ST_burkho))
...
selection_ST_bacilluST_12 <- farthest_distance(rotated_ST_bacillus$PC1, rotated_ST_bacillus$PC2)
...
selection_ST_bacilluST_23 <- farthest_distance(rotated_ST_bacillus$PC2, rotated_ST_bacillus$PC3)
...
selection_ST_bacilluST_34 <- farthest_distance(rotated_ST_bacillus$PC3, rotated_ST_bacillus$PC4)
...
selection_ST_bacilluST_45 <- farthest_distance(rotated_ST_bacillus$PC4, rotated_ST_bacillus$PC5)
...
selection_ST_bacilluST_56 <- farthest_distance(rotated_ST_bacillus$PC5, rotated_ST_bacillus$PC6)
...
p_ST_agro_12 <- p_ST_agro_12 + ggtitle("Agrobacterium") + xlim( min_ST_agro12-40, max_ST_agro12) +
  geom_text(data = rotated_ST_agro[selection_ST_agro_12,], 
            aes(PC1, PC2, label = names(df_agro)[selection_ST_agro_12]),
            hjust = 1, vjust = -.2, size = 6)  +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_burkho_12 <- p_ST_burkho_12 + ggtitle("Burkholderia") + xlim( min_ST_burkho12-40, max_ST_burkho12) +
  geom_text(data = rotated_ST_burkho[selection_ST_burkho_12,], 
            aes(PC1, PC2, label = names(df_burkho)[selection_ST_burkho_12]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_burkho_12

p_ST_para_12 <- ggplot(rotated_ST_para, aes(x = PC1, y = PC2 )) + geom_point() 
p_ST_para_12 <- p_ST_para_12 + ggtitle("Paracoccus") + xlim( min_ST_para12-40, max_ST_para12) +
  geom_text(data = rotated_ST_para[selection_ST_para_12,], 
            aes(PC1, PC2, label = names(df_para)[selection_ST_para_12]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))

p_ST_para_12

p_ST_bacilluST_12 <- ggplot(rotated_ST_bacillus, aes(x = PC1, y = PC2 )) + geom_point() 
p_ST_bacilluST_12 <- p_ST_bacilluST_12 + ggtitle("Bacillus") + xlim( min_ST_bacillus12-40, max_ST_bacillus12) +
  geom_text(data = rotated_ST_bacillus[selection_ST_bacilluST_12,], 
            aes(PC1, PC2, label = names(df_bacillus)[selection_ST_bacilluST_12]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_rhizo_12 <- p_ST_rhizo_12 + ggtitle("Rhizobium") + xlim( min_ST_rhizo12-40, max_ST_rhizo12) +
  geom_text(data = rotated_ST_rhizo[selection_ST_rhizo_12,], 
            aes(PC1, PC2, label = names(df_rhizobium)[selection_ST_rhizo_12]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_rhizo_12

grid.arrange(p_ST_agro_12, p_ST_burkho_12, p_ST_rhizo_12, p_ST_para_12, ncol = 4)
...
p_ST_agro_23 <- p_ST_agro_23 + ggtitle("Agrobacterium") + xlim( min_ST_agro23-40, max_ST_agro23) +
  geom_text(data = rotated_ST_agro[selection_ST_agro_23,], 
            aes(PC2, PC3, label = names(df_agro)[selection_ST_agro_23]),
            hjust = 1, vjust = -.2, size = 6)  +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_burkho_23 <- p_ST_burkho_23 + ggtitle("Burkholderia") + xlim( min_ST_burkho23-40, max_ST_burkho23) +
  geom_text(data = rotated_ST_burkho[selection_ST_burkho_23,], 
            aes(PC2, PC3, label = names(df_burkho)[selection_ST_burkho_23]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_burkho_23

p_ST_para_23 <- ggplot(rotated_ST_para, aes(x = PC2, y = PC3 )) + geom_point() 
p_ST_para_23 <- p_ST_para_23 + ggtitle("Paracoccus") + xlim( min_ST_para23-40, max_ST_para23) +
  geom_text(data = rotated_ST_para[selection_ST_para_23,], 
            aes(PC2, PC3, label = names(df_para)[selection_ST_para_23]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))

p_ST_para_23

p_ST_bacilluST_23 <- ggplot(rotated_ST_bacillus, aes(x = PC2, y = PC3 )) + geom_point() 
p_ST_bacilluST_23 <- p_ST_bacilluST_23 + ggtitle("Bacillus") + xlim( min_ST_bacillus23-40, max_ST_bacillus23) +
  geom_text(data = rotated_ST_bacillus[selection_ST_bacilluST_23,], 
            aes(PC2, PC3, label = names(df_bacillus)[selection_ST_bacilluST_23]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_rhizo_23 <- p_ST_rhizo_23 + ggtitle("Rhizobium") + xlim( min_ST_rhizo23-40, max_ST_rhizo23) +
  geom_text(data = rotated_ST_rhizo[selection_ST_rhizo_23,], 
            aes(PC2, PC3, label = names(df_rhizobium)[selection_ST_rhizo_23]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_rhizo_23

grid.arrange(p_ST_agro_23, p_ST_burkho_23, p_ST_rhizo_23, p_ST_para_23, ncol = 4)
...
p_ST_agro_34 <- p_ST_agro_34 + ggtitle("Agrobacterium") + xlim( min_ST_agro34-40, max_ST_agro34) +
  geom_text(data = rotated_ST_agro[selection_ST_agro_34,], 
            aes(PC3, PC4, label = names(df_agro)[selection_ST_agro_34]),
            hjust = 1, vjust = -.2, size = 6)  +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_burkho_34 <- p_ST_burkho_34 + ggtitle("Burkholderia") + xlim( min_ST_burkho34-40, max_ST_burkho34) +
  geom_text(data = rotated_ST_burkho[selection_ST_burkho_34,], 
            aes(PC3, PC4, label = names(df_burkho)[selection_ST_burkho_34]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_burkho_34

p_ST_para_34 <- ggplot(rotated_ST_para, aes(x = PC3, y = PC4 )) + geom_point() 
p_ST_para_34 <- p_ST_para_34 + ggtitle("Paracoccus") + xlim( min_ST_para34-40, max_ST_para34) +
  geom_text(data = rotated_ST_para[selection_ST_para_34,], 
            aes(PC3, PC4, label = names(df_para)[selection_ST_para_34]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))

p_ST_para_34

p_ST_bacilluST_34 <- ggplot(rotated_ST_bacillus, aes(x = PC3, y = PC4 )) + geom_point() 
p_ST_bacilluST_34 <- p_ST_bacilluST_34 + ggtitle("Bacillus") + xlim( min_ST_bacillus34-40, max_ST_bacillus34) +
  geom_text(data = rotated_ST_bacillus[selection_ST_bacilluST_34,], 
            aes(PC3, PC4, label = names(df_bacillus)[selection_ST_bacilluST_34]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_rhizo_34 <- p_ST_rhizo_34 + ggtitle("Rhizobium") + xlim( min_ST_rhizo34-40, max_ST_rhizo34) +
  geom_text(data = rotated_ST_rhizo[selection_ST_rhizo_34,], 
            aes(PC3, PC4, label = names(df_rhizobium)[selection_ST_rhizo_34]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_rhizo_34

grid.arrange(p_ST_agro_34, p_ST_burkho_34, p_ST_rhizo_34, p_ST_para_34, ncol = 4)
...
p_ST_agro_45 <- p_ST_agro_45 + ggtitle("Agrobacterium") + xlim( min_ST_agro45-40, max_ST_agro45) +
  geom_text(data = rotated_ST_agro[selection_ST_agro_45,], 
            aes(PC4, PC5, label = names(df_agro)[selection_ST_agro_45]),
            hjust = 1, vjust = -.2, size = 6)  +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_burkho_45 <- p_ST_burkho_45 + ggtitle("Burkholderia") + xlim( min_ST_burkho45-40, max_ST_burkho45) +
  geom_text(data = rotated_ST_burkho[selection_ST_burkho_45,], 
            aes(PC4, PC5, label = names(df_burkho)[selection_ST_burkho_45]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_burkho_45

p_ST_para_45 <- ggplot(rotated_ST_para, aes(x = PC4, y = PC5 )) + geom_point() 
p_ST_para_45 <- p_ST_para_45 + ggtitle("Paracoccus") + xlim( min_ST_para45-40, max_ST_para45) +
  geom_text(data = rotated_ST_para[selection_ST_para_45,], 
            aes(PC4, PC5, label = names(df_para)[selection_ST_para_45]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))

p_ST_para_45

p_ST_bacilluST_45 <- ggplot(rotated_ST_bacillus, aes(x = PC4, y = PC5 )) + geom_point() 
p_ST_bacilluST_45 <- p_ST_bacilluST_45 + ggtitle("Bacillus") + xlim( min_ST_bacillus45-40, max_ST_bacillus45) +
  geom_text(data = rotated_ST_bacillus[selection_ST_bacilluST_45,], 
            aes(PC4, PC5, label = names(df_bacillus)[selection_ST_bacilluST_45]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_rhizo_45 <- p_ST_rhizo_45 + ggtitle("Rhizobium") + xlim( min_ST_rhizo45-40, max_ST_rhizo45) +
  geom_text(data = rotated_ST_rhizo[selection_ST_rhizo_45,], 
            aes(PC4, PC5, label = names(df_rhizobium)[selection_ST_rhizo_45]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_rhizo_45

grid.arrange(p_ST_agro_45, p_ST_burkho_45, p_ST_rhizo_45, p_ST_para_45, ncol = 4)
...
p_ST_agro_56 <- p_ST_agro_56 + ggtitle("Agrobacterium") + xlim( min_ST_agro56-40, max_ST_agro56) +
  geom_text(data = rotated_ST_agro[selection_ST_agro_56,], 
            aes(PC5, PC6, label = names(df_agro)[selection_ST_agro_56]),
            hjust = 1, vjust = -.2, size = 6)  +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_burkho_56 <- p_ST_burkho_56 + ggtitle("Burkholderia") + xlim( min_ST_burkho56-40, max_ST_burkho56) +
  geom_text(data = rotated_ST_burkho[selection_ST_burkho_56,], 
            aes(PC5, PC6, label = names(df_burkho)[selection_ST_burkho_56]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_burkho_56

p_ST_para_56 <- ggplot(rotated_ST_para, aes(x = PC5, y = PC6 )) + geom_point() 
p_ST_para_56 <- p_ST_para_56 + ggtitle("Paracoccus") + xlim( min_ST_para56-40, max_ST_para56) +
  geom_text(data = rotated_ST_para[selection_ST_para_56,], 
            aes(PC5, PC6, label = names(df_para)[selection_ST_para_56]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))

p_ST_para_56 

p_ST_bacilluST_56 <- ggplot(rotated_ST_bacillus, aes(x = PC5, y = PC6 )) + geom_point() 
p_ST_bacilluST_56 <- p_ST_bacilluST_56 + ggtitle("Bacillus") + xlim( min_ST_bacillus56-40, max_ST_bacillus56) +
  geom_text(data = rotated_ST_bacillus[selection_ST_bacilluST_56,], 
            aes(PC5, PC6, label = names(df_bacillus)[selection_ST_bacilluST_56]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
p_ST_rhizo_56 <- p_ST_rhizo_56 + ggtitle("Rhizobium") + xlim( min_ST_rhizo56-40, max_ST_rhizo56) +
  geom_text(data = rotated_ST_rhizo[selection_ST_rhizo_56,], 
            aes(PC5, PC6, label = names(df_rhizobium)[selection_ST_rhizo_56]),
            hjust = 1.25, vjust = -.2, size = 6) +
  theme(plot.title = element_text(size=20, face="bold", vjust=2))
p_ST_rhizo_56

grid.arrange(p_ST_agro_56, p_ST_burkho_56, p_ST_rhizo_56, p_ST_para_56, ncol = 4)
